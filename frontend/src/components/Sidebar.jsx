...
const Sidebar = ({ currentPath }) => {
    ...
    if (user?.role === 'MAIN') {
        menu.push({ name: 'Manage Teachers', path: '/manage-teachers', icon: 'M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z' });
    }
    ...
    return (
        <div className="w-64 bg-white h-screen border-r border-gray-100 flex flex-col fixed left-0 top-0">
            <div className="p-6 border-b border-gray-100">
                <h1 className="text-xl font-bold text-gray-800">Smart Tracker</h1>
                <p className="text-xs text-gray-500 mt-1 capitalize">{user?.role} Teacher</p>
            </div>
